...
contract LiveMintFactorySingle is ERC721URIStorage, Ownable, ERC2981, ReentrancyGuard {
...
contract LiveMintAuctionSingle is ReentrancyGuard {
  using Counters for Counters.Counter;
...
////////////////////// GETTERS //////////////////////////////
  ...
  function getCurrentItem() external view returns (uint256) {
      LiveMintFactorySingle mintContract = LiveMintFactorySingle(nftContract); 
