...
// contract LiveMintFactoryProxy is Initializable, ERC721Upgradeable, OwnableUpgradeable, ERC2981Upgradeable, ReentrancyGuardUpgradeable {
...
//     address payable public nftyTunesAddress = payable(0x0fE9fE5F571424e18B60D2Ba72Fd73e48209E9Fd);
...
//                 payable(nftyTunesAddress).transfer(fundsByBidder[winningBidders[i]] * nftyTunesFee/100);
...
//         mintContract.initialize(name, symbol, artist, _mintAmount, _royaltyValue, _payeeOne, _payeeTwo, _payeeOneFee, _payeeTwoFee, _nftyTunesFee);
