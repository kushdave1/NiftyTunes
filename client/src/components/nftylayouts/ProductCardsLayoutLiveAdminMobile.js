...
function ProductCardsLayoutLiveAdminMobile({index, owner, ownerName, artistName, artist, artistPhoto, 
collection, image, coverArt, name, description, nft, auctionAddress, editionsPerAuction, fileType}) {
    ...
    <>
       ...
       <Col style={{paddingBottom:"20px", display: "flex", alignItems: "center", justifyContent: "center"}}>
        <Card className="bg-light shadow-sm"
              style={{ width: '23rem', height: '35rem', borderRadius:'.50rem', cursor: "pointer", overflow: "hidden"}} >
...
export default ProductCardsLayoutLiveAdminMobile