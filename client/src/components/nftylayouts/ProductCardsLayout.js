  ...
  return (
    <Col xs={1} md={4}>
      <Card className="bg-light shadow-sm p-2" onClick={() => console.log('clicked')}
          ...
          <Row className="d-flex flex-row" style={{flexDirection:"column"}}> 
            <Col>
              <Button className="button-hover" variant="secondary" style={{ color: "white", background: "black" }} onMouseEnter={changeBackground} onMouseOut={changeBackgroundBack} onClick={() => BuyNFT(nft, marketAddress, marketContractABI)}>Buy</Button>
            </Col>
