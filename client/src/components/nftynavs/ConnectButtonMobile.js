...
function ConnectButton(props) {
    ...
    const {authenticate, isAuthenticated, isAuthenticating, hasAuthError, authError, user, logout, account, Moralis} = useMoralis();
    ...
    return isAuthenticated?(
        ...
        <Modal show={show} onHide={handleClose} fullscreen={true} >  
            ...
            <ModalContent>
                ...
                <PayForNFTs>How would you like to <br/>pay for your NFTs?</PayForNFTs>
