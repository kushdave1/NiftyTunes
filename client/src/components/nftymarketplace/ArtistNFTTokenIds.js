...
function ArtistNFTTokenIds() {
  ...
  const fetchNFTs = async() => {
    try {
      const tokenIds = await fetchArtistTokenIds( marketAddress, marketContractABI, storageAddress, storageContractABI );
      setNFTs(tokenIds)
...
export default ArtistNFTTokenIds